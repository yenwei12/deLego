            ...
            if (json.extensionsUsed) {
                for (var i = 0; i < json.extensionsUsed.length; ++i) {
                    ...
                    switch (extensionName) {
                        ...
                        default:
                            if (
                                extensionsRequired.indexOf(extensionName) >=
                                    0 &&
    ...
    function GLTFMaterialsPbrSpecularGlossinessExtension() {
        return {
            ...
            createMaterial: function (materialParams) {
                ...
                material.aoMap =
                    materialParams.aoMap === undefined
                        ? null
                        : materialParams.aoMap;
                ...
                material.envMap =
                    materialParams.envMap === undefined
                        ? null
                        : materialParams.envMap;
    ...
    GLTFParser.prototype.loadNode = function (nodeIndex) {
        ...
        return (function () {
            ...
            if (
                ...
                pending.push(
                    parser
                        .getDependency("light", lightIndex)
                        .then(function (light) {
                            return parser._getNodeRef(
                                parser.lightCache,
                                lightIndex,
